...
<div class="container">
    <div class="row">
        ...
        <p><center>->Multiple Disabilities<br>->Multiple Disabilities including Deaf Blindness<br>->Multiple Disabilities including Deaf Dumb</center></p>
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        if(isset($_GET['search']))
                        {
                            ...
                            $query = "SELECT * FROM multi WHERE CONCAT(Disability_Type,Scheme_Name,Disability_Benefits_Criteria,Type_of_Benefits ) LIKE '%$filtervalues%' ";
