...
<div class="container">
    <div class="row">
        ...
        <p><center>->Locomotor Disability<br>->Leprosy cured<br>->Cerebral Palsy<br>->Muscular Dystrophy<br>->Acid Attack Victim<br>->Blindness<br>->Hearing Impairment</center></p>
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        if(isset($_GET['search']))
                        {
                            ...
                            $query = "SELECT * FROM schemes WHERE CONCAT(Disability_Type,Scheme_Name,Disability_Benefits_Criteria,Type_of_Benefits ) LIKE '%$filtervalues%' ";
