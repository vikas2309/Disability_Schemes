                        ...
                        <div class="col-md-7">
                            ...
                            <form action="" method="GET">
                                <div class="input-group mb-3">
                                    ...
                                    <h1><center><a href="disca2.php" class = "btn btn-primary">Search</a></center></h1>
                                </div>
                            </form>
            ...
            <div class="card mt-4">
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        $query = "SELECT Disability_Type,Scheme_Name,Disability_Benefits_Criteria,Type_of_Benefits FROM dis ";
