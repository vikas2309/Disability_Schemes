...
<head>
    ...
    <title>Disability caused due to</title>
</head>
<body>
...
<div class="container">
    <div class="row">
        ...
        <p><center>->Chronic Neurological Conditions<br>->Multiple Sclerosis<br>->Parkinson’s Disease<br>->Haemophilia<br>->Thalassemia<br>->Sickle Cell Disease</center></p>
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        if(isset($_GET['search']))
                        {
                            ...
                            $query = "SELECT * FROM dis WHERE CONCAT(Disability_Type,Scheme_Name,Disability_Benefits_Criteria,Type_of_Benefits ) LIKE '%$filtervalues%' ";
