...
<div class="container">
    <div class="row">
        ...
        <p><center>->Mental illness<br>->Mental retardation<br>->Autism Spectrum Disorder</center></p>
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        if(isset($_GET['search']))
                        {
                            ...
                            $query = "SELECT * FROM mental WHERE CONCAT(Disability_Type,Scheme_Name,Disability_Benefits_Criteria,Type_of_Benefits ) LIKE '%$filtervalues%' ";
